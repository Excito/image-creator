...
DEBIAN_FRONTEND=noninteractive DEBCONF_NONINTERACTIVE_SEEN=true apt-get install -y bubba-kernel bubba-modules bubba-buttond bubba-status lvm2 openssh-server dhcp3-client ifplugd less
